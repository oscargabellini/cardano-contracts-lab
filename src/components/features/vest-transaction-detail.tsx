...
export type VestingTransactionDetails = {
  txHash: string;
  action: "Vest Funds" | "Unvest Funds";
  amount: number;
  unlockDate: string;
};

export type VestingTransactionDetailsModalProps = {
  transactionDetails: VestingTransactionDetails;
  open: boolean;
  onOpenChange: (open: boolean) => void;
};

export const VestingTransactionDetailsModal = (
  props: VestingTransactionDetailsModalProps
) => {
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-secondary/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-lg font-semibold text-card-foreground">
                  {DateTime.fromISO(
                    props.transactionDetails.unlockDate
